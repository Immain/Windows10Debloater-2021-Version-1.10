...
$office365.Add_Click({
    ...
    Write-Host "Installed Office 365 Business"
})

$openoffice.Add_Click({
    Write-Host "Installing Open Office"
    choco install openoffice -y
    Write-Host "Installed Open Office"
})
...
$essentialtweaks.Add_Click({
    ...
    Start-BitsTransfer -Source "https://raw.githubusercontent.com/Immain/Windows10Debloater-2021-Updated/main/DeepSixSecurity-ooshutup10.cfg" -Destination DeepSixSecurity-ooshutup10.cfg        OOSU10 DeepSixSecurity-ooshutup10.cfg /quiet
